...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Craete Admin
        $admin = User::create(['first_name' => 'Admin', 'last_name' => 'System', 'username' => 'admin', 'email' => 'admin@ecommerce.com', 'email_verified_at' => now(), 'mobile' => '0566631234', 'status' => 1, 'password' => bcrypt('123123123'), 'user_image' => 'default-avatar.png', 'remember_token' => Str::random(10),]);
        $admin->attachRole($adminRole);


        // Craete Supervisor
        $supervisor = User::create(['first_name' => 'Supervisor', 'last_name' => 'System', 'username' => 'Supervisor', 'email' => 'supervisor@ecommerce.com', 'email_verified_at' => now(), 'mobile' => '0566631237', 'status' => 1, 'password' => bcrypt('123123123'), 'user_image' => 'default-avatar.png', 'remember_token' => Str::random(10),]);
        $supervisor->attachRole($supervisorRole);

        // Craete Customer
        $customer = User::create(['first_name' => 'Sultan', 'last_name' => 'Aloufi', 'username' => 'sultan', 'email' => 'sool.707@gmail.com', 'email_verified_at' => now(), 'mobile' => '0566631233', 'status' => 1, 'password' => bcrypt('123123123'), 'user_image' => 'default-avatar.png', 'remember_token' => Str::random(10),]);
        $customer->attachRole($customerRole);

        for ($i = 1; $i <= 20; $i++) {
            // Craete Customer by faker
