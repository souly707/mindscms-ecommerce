                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-lg rounded" name="first_name" type="text"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-lg rounded" name="last_name" type="text"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-lg rounded" name="username" type="text"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-lg rounded" name="email" type="email"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-lg rounded" name="mobile" type="text"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-lg rounded" name="password" type="password"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-lg rounded" name="password_confirmation"
