                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="pagesDropdown"
                                    ...
                                    <div class="dropdown-menu mt-3" aria-labelledby="pagesDropdown">
                                        ...
                                        <a class="dropdown-item border-0 transition-link"
                                            ...
                                            detail</a>
                                        <a class="dropdown-item border-0 transition-link"
                                            href="{{ route('frontend.cart') }}">Shopping cart
                                        </a>
                                        <a class="dropdown-item border-0 transition-link"
                                            href="{{ route('frontend.checkout') }}">Checkout
                                        </a>
                                    </div>
                                </li>
                            </ul>
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#"> <i
                                            class="far fa-heart mr-1"></i><small class="text-gray">
                                            (0)</small></a></li>
                                <li class="nav-item"><a class="nav-link" href="#"> <i
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 text-lg-right">
                                <p class="small text-muted mb-0">Template designed by <a class="text-white reset-anchor"
                                        href="https://bootstraptemple.com/p/bootstrap-ecommerce">Bootstrap Temple</a>
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row align-items-stretch">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="p-5 my-md-4">
                                        ...
                                        <p class="text-small mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit. In ut
                                        ...
                                        <div class="row align-items-stretch mb-4">
                                            ...
                                            <div class="col-sm-5 pl-sm-0"><a
                                                ...
                                                class="far fa-heart mr-2"></i>Add to wish
                                            list</a>
                                    </div>
                                </div>
                            </div>
