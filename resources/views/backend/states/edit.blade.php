    ...
    <div class="card-body">
        <form action="{{ route('admin.states.update', $state->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <select name="country_id" class="form-control">
                        ...
                        <option
                            value="{{ $country->id }} {{ old('country_id', $state->country_id) == $country->id ? 'selected' : null }}">
                            {{ $country->name }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-4">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value="0" {{ old('status', $state->status) == '0' ? 'selected' : null }}>Inactive
                        </option>
                    </select>
            ...
            <div class="form-group mt-4">
                <button type="submit" name="submit" class="btn btn-outline-primary">Update State</button>
            </div>
        </form>
    </div>
</div>
