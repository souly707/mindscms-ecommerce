...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex">
        ...
        <div class="ml-auto">
            <a href="{{ route('admin.product_categories.index') }}" class="btn btn-outline-primary">
                <span class="icon">
    ...
    <div class="card-body">
        <form action="{{ route('admin.product_categories.update', $productCategory->id) }}" method="POST"
            ...
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <select name="status" class="form-control">
                        <option value="1" {{ old('status', $productCategory->status) == 1 ? 'selected' : null }}>Active
                        </option>
            ...
            <div class="form-group mt-4">
                <button type="submit" name="submit" class="btn btn-outline-primary">Update Category</button>
            </div>
        </form>
    </div>
</div>
