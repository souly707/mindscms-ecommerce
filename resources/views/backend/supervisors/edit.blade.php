    ...
    <div class="card-body">
        <form action="{{ route('admin.supervisors.update', $supervisor->id) }}" method="POST"
            ...
            <div class="row pt-4">
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="mobile" value="{{ old('mobile', $supervisor->mobile) }}"
                            class="form-control">
                ...
                <div class="col-4">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value="0" {{ old('status', $supervisor->status) == '0' ? 'selected' : null }}>Inactive
                        </option>
                    </select>
            ...
            <div class="form-group mt-4">
                <button type="submit" name="submit" class="btn btn-outline-primary">Update supervisor</button>
            </div>
        </form>
    </div>
</div>
