...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex">
        ...
        <div class="ml-auto">
            @ability('admin', 'manage_customers, show_customers')
    ...
    <div class="card-body">
        <form action="{{ route('admin.customers.update', $customer->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row pt-4">
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="mobile" value="{{ old('mobile', $customer->mobile) }}"
                            class="form-control">
                ...
                <div class="col-4">
                    ...
                    <select name="status" class="form-control">
                        <option value="1" {{ old('status', $customer->status) == '1' ? 'selected' : null }}>Active
                        </option>
                        <option value="0" {{ old('status', $customer->status) == '0' ? 'selected' : null }}>Inactive
                        </option>
                    </select>
            ...
            <div class="form-group mt-4">
                <button type="submit" name="submit" class="btn btn-outline-primary">Update Customer</button>
            </div>
        </form>
    </div>
</div>
