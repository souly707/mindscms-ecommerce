...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex">
        ...
        <div class="ml-auto">
            <a href="{{ route('admin.product_coupons.index') }}" class="btn btn-outline-primary">
                <span class="icon">
            ...
            <div class="row">
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="code" id="code" value="{{ old('code', $productCoupon->code) }}"
                            class="form-control">
                ...
                <div class="col-3">
                    ...
                    <select name="type" class="form-control">
                        ...
                        <option value="percentage"
                            {{ old('type', $productCoupon->type) == 'percentage' ? 'selected' : null }}>Percentage
                        </option>
                ...
                <div class="col-3">
                    <div class="form-group">
                        <label for="use_times">Ues Times</label>
            ...
            <div class="row mt-4">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="greater_than"
                            value="{{ old('greater_than', $productCoupon->greater_than) }}" class="form-control">
                ...
                <div class="col-3">
                    ...
                    <select name="status" class="form-control">
                        <option value="1" {{ old('status', $productCoupon->status) == '1' ? 'selected' : null }}>Active
                        </option>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" class="form-control"
                            rows="5">{{ old('description', $productCoupon->description) }}</textarea>
                    </div>
                </div>
            </div>

            <div class="form-group mt-4">
                <button type="submit" name="submit" class="btn btn-outline-primary">Add Coupon</button>
            </div>
...
<script>
    ...
    $( document ).ready(function() {
        ...
        $('#start_date').pickadate({
            ...
            clear: 'clear',
            close: 'ok',
            closeOnSelect: true, // close open selected date
        });
