...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex">
        ...
        <div class="ml-auto">
            <a href="{{ route('admin.customer_addresses.index') }}" class="btn btn-outline-primary">
                <span class="icon">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.customer_addresses.update', $customer_address->id) }}" method="post">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="address_title"
                            value="{{ old('address_title', $customer_address->address_title) }}" class="form-control">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="last_name" value="{{ old('last_name', $customer_address->last_name) }}"
                            class="form-control">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="email" value="{{ old('email', $customer_address->email) }}"
                            class="form-control">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="mobile" value="{{ old('mobile', $customer_address->mobile) }}"
                            class="form-control">
            ...
            <div class="row">
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="address" value="{{ old('address', $customer_address->address) }}"
                            class="form-control">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="address2" value="{{ old('address2', $customer_address->address2) }}"
                            class="form-control">
            ...
            <div class="form-group pt-4">
                <button type="submit" name="submit" class="btn btn-outline-primary">Update Address</button>
            </div>
        </form>
    </div>
</div>
