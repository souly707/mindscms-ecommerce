    ...
    <div class="card-body">
        <form action="{{ route('admin.cities.update', $city->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <select name="state_id" class="form-control">
                        ...
                        <option
                            value="{{ $state->id }} {{ old('state_id', $city->state_id) == $state->id ? 'selected' : null }}">
                            {{ $state->name }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-4">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value="0" {{ old('status', $city->status) == '0' ? 'selected' : null }}>Inactive
                        </option>
                    </select>
            ...
            <div class="form-group mt-4">
                <button type="submit" name="submit" class="btn btn-outline-primary">Update city</button>
            </div>
        </form>
    </div>
</div>
